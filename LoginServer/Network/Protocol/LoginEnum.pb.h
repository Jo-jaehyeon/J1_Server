...
#ifndef GOOGLE_PROTOBUF_INCLUDED_LoginEnum_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_LoginEnum_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_LoginEnum_2eproto
...
struct TableStruct_LoginEnum_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_LoginEnum_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace Login {
...
template <> struct is_proto_enum< ::Login::PacketType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Login::PacketType>() {
  return ::Login::PacketType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_LoginEnum_2eproto
