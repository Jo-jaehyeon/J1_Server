...
public:
	static void Init()
	{
		...
		GPacketHandler[Chat::MessageCode::PKT_REQ_LOGIN] = [](SessionPtr& session, boost::asio::mutable_buffer& buffer, int32& offset) {
			return DispatchPacket<Chat::REQ_LOGIN>(Handle_REQ_LOGIN, session, buffer, offset);
			};
		GPacketHandler[Chat::MessageCode::PKT_REQ_LIST] = [](SessionPtr& session, boost::asio::mutable_buffer& buffer, int32& offset) {
		...
		GPacketHandler[Chat::MessageCode::PKT_REQ_CHATNOTI] = [](SessionPtr& session, boost::asio::mutable_buffer& buffer, int32& offset) {
