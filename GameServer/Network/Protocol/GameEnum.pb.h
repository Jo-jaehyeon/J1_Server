...
enum PacketType : int {
  ...
  PKT_REQ_CHECK_NICKNAME = 1002,
  PKT_RES_CHECK_NICKNAME = 1003,
  PKT_REQ_CREATE_CHARACTER = 1004,
  PKT_RES_CREATE_CHARACTER = 1005,
  PKT_REQ_DELETE_CHARACTER = 1006,
  PKT_RES_DELETE_CHARACTER = 1007,
  PKT_REQ_ENTER_GAME = 1008,
  PKT_RES_ENTER_GAME = 1009,
  PKT_REQ_LEAVE_GAME = 1010,
  PKT_RES_LEAVE_GAME = 1011,
  PKT_REQ_ATTACK = 2000,
  PKT_RES_ATTACK = 2001,
